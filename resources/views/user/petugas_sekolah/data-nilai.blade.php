                            ...
                            <table id="dataTable" class="table table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Bacaan Al-Qur'an</th>
                                        <th scope="col">Praktek Ibadah</th>
                                        <th scope="col">Doa Harian</th>
                                        <th scope="col">Action</th>
                                    </tr>
                                </thead>
                            </table>

                            @include('components.modal-nilai')
    ...
    @push('js')
        ...
        <script>
            ...
            function editFunc(id) {
                $.ajax({
                    type: "POST",
                    url: "{{ route('admin.siswa.editNilai') }}",
                    data: {
                        id: id,
                        _token: "{{ csrf_token() }}"
                    },
                    ...
                    success: function(res) {
                        ...
                        $('.modal-title-nilai').html("Edit Nilai");
                        ...
                        $('#matematika').val(res.data.matematika);
                        $('#bahasa_indonesia').val(res.data.bahasa_indonesia);
                        $('#bahasa_inggris').val(res.data.bahasa_inggris);
                        $('#ipa').val(res.data.ipa);
                        $('#agama').val(res.data.agama);
                        $('#bacaan_quran').val(res.data.bacaan_quran);
                        $('#praktek_ibadah').val(res.data.praktek_ibadah);
                        $('#doa_harian').val(res.data.doa_harian);
            ...
            function hapusFunc(id) {
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "{{ route('admin.siswa.hapusDataNilai') }}",
                            data: {
                                id: id,
                                _token: "{{ csrf_token() }}"
                            },
            ...
            $('#simpan').on('click', function() {
                $.ajax({
                    type: "POST",
                    dataType: 'json',
                    url: "{{ route('admin.siswa.updateNilai') }}",
                    data: {
                        id: $('#id').val(),
                        matematika: $('#matematika').val(),
                        bahasa_indonesia: $('#bahasa_indonesia').val(),
                        bahasa_inggris: $('#bahasa_inggris').val(),
                        ipa: $('#ipa').val(),
                        agama: $('#agama').val(),
                        bacaan_quran: $('#bacaan_quran').val(),
                        praktek_ibadah: $('#praktek_ibadah').val(),
                        doa_harian: $('#doa_harian').val(),
