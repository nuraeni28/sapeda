                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @include('components.modal-ruangan')
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                var table = $('#dataTable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('admin.siswa.data-siswa-tes') }}",
                    columns: [{
            ...
            function Ruangan(id) {
                ...
                $('.modal-title').html("Ruangan");
                $('#scrollingModalRuangan').modal('show', {
                    keyboard: false
                });
                if (id) {
                    $('#simpanRuangan').off('click').on('click', function() {
                        $.ajax({
                            type: "POST",
                            dataType: 'json',
