...
<body>
    <div class="card">
        <div class="container">
            <img class=kanan src="{{ asset('assets/images/logo.jpg') }}" />
            <div class="text">
        ...
        <div style="align: justify;">
            <img class=kiri src="{{ asset('storage/'.$siswa->foto) }}" />
        </div>
        @php
        ...
        <div class="student-info">
            ...
            <p>2. pengumuman hasil seleksi ppdb tanggal 31 Oktober 2023 s.d 31 November 2023 melalui website
                http//SAPEDA.com</p>
            <p align="center">
                <button onclick="window.location.href='{{ route('user.download-pdf-kartu-tes') }}'"><i
                        class="fa fa-print">
                        Cetak Kartu Test
                    </i></button>
            </p>
